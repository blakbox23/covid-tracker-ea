...
describe('reducer', () => {
    test('should update the state and accept country values from the API', () => {
        ...
        const country = newState.countries[0].countries[0].country
        const cases = newState.countries[0].countries[0].cases
    ...
    test('should update the state and accept countryData values from the API', () => {
        ...
        const newState = reducer({}, action);
        const active = newState.countries[0].countryData.active
